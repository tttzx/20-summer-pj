...
public class FriendDAO {
    ...
    public static FriendRequest findRequest(String from, String to) {
        ...
        try {
            ...
            rs = pst.executeQuery();
            while (rs.next()) {
                request = new FriendRequest(rs.getString("friendID"), from, to, rs.getInt("status"));
            }
            return request;
    ...
    public static void send(FriendRequest request) {
        Connection conn = jdbcUtil.getConnection();
